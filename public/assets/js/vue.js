...
var Vue = (function (exports) {
            ...
            for (let i = 0; i < l; i++) {
                ...
                if (node) {
                    if (isText && !optimized) {
                        ...
                        if (
                            next &&
                            (next = normalizeVNode(next)).type === Text
                        ) {
                            insert(
                                createText(
  ...
  Use a v-bind binding combined with a v-on listener that emits update:x event instead.`,
    ...
    const getExpSource = (exp) =>
        exp.type === 4 ? exp.content : exp.loc.source;
                ...
                if (quote !== 0) {
                    ...
                    if (currentProp.type === 6) {
                        if (currentProp.name === "class") {
                            currentAttrValue =
                                condense(currentAttrValue).trim();
                        }
