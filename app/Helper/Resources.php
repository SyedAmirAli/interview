...
final class Resources
{
    public const COUNTRIES = [
        ...
        "CD" => ['code' => "CD", 'name' => "Congo, Democratic Republic of the"],
        ...
        "NL" => ['code' => "NL", 'name' => "Netherlands, Kingdom of the"],
        ...
        "GB" => ['code' => "GB", 'name' => "United Kingdom of Great Britain and Northern Ireland"],
    ...
    public static function saveFile($request, string $key = 'image', string $path = 'uploads/', string $oldPath = null)
    {
        if ($request->hasFile($key)) {
            ...
            $filename = time() . '-----' . (strlen(pathinfo($originalName, PATHINFO_FILENAME)) < 120
                ? pathinfo($originalName, PATHINFO_FILENAME)
                : substr(pathinfo($originalName, PATHINFO_FILENAME), 0, 120))
                . '.' . $extension;
